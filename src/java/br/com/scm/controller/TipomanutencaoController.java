...
public class TipomanutencaoController implements Serializable {
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle_SCM").getString("ExclusaoSucesso"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle_SCM").getString("ExclusaoErro"));
        }
    }
